...
['Pokes','lcpokes',''],
['Ray Ban Meta / Stories','lcraybans','Hide the Ray Ban Stories/ Ray Ban Meta link in the left column'],
['Reels','lcreels',''],
...
// top nav background image
  ...
  for(var b=0;b<lcoptsarr.length;b++)
    ...
    if(fbpoptsobj.lcraybans==1)
      fbpfreestyle.textContent += ' ' + leftrailcode3 + ' a[href*="www.ray-ban.com"], div[data-isanimatedlayout] a[href*="www.ray-ban.com"], li>div>a[href*="www.ray-ban.com"], a[href*="www.meta.com%2Fglasses"], a[href*="www.meta.com%2Fsmart-glasses"], a[href^="https://www.meta.com/glasses"] {display:none !important}';
